...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  // 2: Extend Layer
  KEYMAP(
      KC_GRV,   KC_NO,   KC_NO,   KC_NO,   KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,   KC_MUTE, KC_VOLD,  KC_VOLU, KC_DEL,  KC_PSCR,   \
      KC_NO,   RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI,RGB_VAI,RGB_HUD,RGB_SAD,RGB_VAD,KC_NO,   KC_NO,   KC_SLCK,  KC_PAUS,           KC_NO,    \
