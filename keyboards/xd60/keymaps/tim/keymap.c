...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(
      ...
      KC_LCTL, KC_LGUI, KC_LALT,                          KC_SPC,                          KC_APP,  KC_NO,    KC_NO,   KC_NO,    KC_END),

  // 2: Extend Layer
  KEYMAP(
      KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,   KC_MUTE, KC_VOLD,  KC_VOLU, KC_PAUS,  KC_PSCR,   \
      KC_NO,   RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI,RGB_VAI,RGB_HUD,RGB_SAD,RGB_VAD,KC_NO,   KC_NO,   KC_SLCK,  KC_PAUS,           KC_DEL,    \
      F(1),    KC_NO,   KC_NO,   KC_NO,   KC_NO,  KC_NO,  KC_LEFT,KC_DOWN,KC_UP,  KC_RIGHT,LCTL(KC_BSPC),KC_NO,KC_NO,            KC_ENT,    \
